...
//    }
    ...
    public ResponseEntity<StandardResponse> findOrder(@RequestHeader String token, @RequestParam("searchText") String searchText, @RequestParam("page") int page, @RequestParam("pageSize") @Max(50) int pageSize, @RequestParam(name = "byWhom", defaultValue = "customer") String byWhom, @RequestParam(name = "vendor_email", defaultValue = "") String vendor_email, @RequestParam(name = "customer_email", defaultValue = "") String customer_email) {
