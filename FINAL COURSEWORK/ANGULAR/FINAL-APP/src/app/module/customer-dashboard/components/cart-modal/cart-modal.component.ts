...
export class CartModalComponent implements OnInit {
  ...
  constructor(public route: Router, public formBuilder: FormBuilder, public dialogRef: MatDialogRef<CartModalComponent>, @Inject(MAT_DIALOG_DATA) public data: {
    data: any[]
  }, private buyingCartService: BuyingCartService, private checkoutPageService: CheckoutPageService) {
  }
